...
- **It elicits AI systems' probabilistic prediction of events and makes real-world betting decisions accordingly**. Hence, *strong performance on some metrics (e.g., the Average Return) translates directly to positive betting gain in the real world*. As a subtle and perhaps counterintuitive caveat, we remark that high average market return does not necessarily align with high prediction accuracy (see our [**detailed ranking blog**](https://ai-prophet.github.io/pm_ranking/blogpost/ranking_llm_250727.html) for explanations).     
...
- Placeholder for auto-generated references
