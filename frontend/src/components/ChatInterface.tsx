      ...
      <div className="flex-shrink-0 h-11 border-b border-edge bg-surface/80 backdrop-blur-sm flex items-center justify-between px-3">
        ...
        <div className="flex items-center gap-0.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-xs font-semibold text-muted hover:text-secondary hover:bg-surface-hover transition-all duration-150 disabled:opacity-25 disabled:cursor-not-allowed"
            title="New forecast"
          >
